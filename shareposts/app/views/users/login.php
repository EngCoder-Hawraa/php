      ...
      <div class="card card-body bg-light mt-5 pt-4 pb-4">
        ...
        <form action="<?php echo URLROOT; ?>/users/login" method="post">
          ...
          <div class="row mt-3 pt-2">
            <div class="col">
              <input type="submit" value="Login" class="col-12 btn btn-success btn-block">
            </div>
            <div class="col">
              <a href="<?php echo URLROOT; ?>/users/register" class="col-12 btn btn-light btn-block">No account? Register</a>
            </div>
          </div>
        </form>
      </div>
